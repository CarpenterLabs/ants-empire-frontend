...
import styles from '../styles/CoolDownQuest.module.scss';
...
const CoolDownQuest = (props: { remainingMilliseconds: number; refreshQuestData: () => Promise<void>; colony: Colony }) => {
  ...
  useEffect(() => {
    const calculateCount = () => {
      ...
      if (remainingMilliseconds <= 0) {
        clearInterval(timer);
        (async () => {
          if (props.refreshQuestData) {
            await props.refreshQuestData();
          }
        })();
        return;
      }
  ...
  return (
    <div className={styles.coolDownQuest}>
